...
export function AboutSection() {
  return (
    <section
      className="py-20 bg-surface cyber-grid data-stream-slow data-stream-vertical light-zone-accent circuit-lights"
      id="about"
    >
          ...
          <div className="grid md:grid-cols-2 gap-16 items-top">
            ...
            >
              ...
              <div className="space-y-4 text-lg text-text leading-relaxed">
                <p>
                  Beatriz Knabben is a front-end developer with experience
                  creating modern, responsive interfaces using technologies such
                  as Liquid (Shopify), Vue.js, React, Next.js, TypeScript, and
                  Tailwind CSS.
                </p>
                <p>
                  She also works with social media management, paid traffic
                  (Meta Ads), and automation tools like n8n. Currently expanding
                  her skills in back-end development and cybersecurity, Beatriz
                  is on the path to becoming a full stack developer.
                </p>
                <p>
                  Focused on delivering secure and scalable digital solutions
                    ...
                    >
                      ...
                      <div className="relative z-10">
                        <div className="flex justify-between items-start mb-3">
                          ...
                          <span
                            className={`text-sm px-3 py-1 border rounded-sm ${

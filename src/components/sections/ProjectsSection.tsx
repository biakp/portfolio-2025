...
const projects = [
  {
    id: 1,
    title: "Space Travel - Full-Stack Study Project",
    description:
    ...
    technologies: ["Vite", "React.js", "MongoDB", "Fastify", "Tailwind CSS"],
    github: "https://github.com/biakp/space-travel",
    live: "/projects/space-travel",
    featured: true,
  },
  {
    id: 2,
    ...
    description:
      "Premium e-commerce theme developed for the Tray platform using Twig templating engine. Splendore combines elegant design with high-performance optimization and advanced functionality for sophisticated online stores.",
  ...
  },
  {
    ...
    description:
      "Custom WhatsApp messaging workflow using n8n, self-hosted in Docker. Automates message delivery based on Google Sheets data with advanced conditional logic and anti-spam protection.",
  ...
  },
  {
    ...
    description:
      "Custom e-commerce storefront for a premium shoe brand using Shopify's Dawn theme. Features advanced Liquid templating, dynamic sections, and performance optimization for a high-end shopping experience.",
    technologies: [
      "Shopify Liquid",
      "Dawn Theme",
      "SCSS",
  ...
  },
  {
    ...
    description:
      "Modern cyberpunk portfolio website built with Next.js 15, featuring custom animations, interactive cursor effects, mobile navigation, and responsive design with a futuristic aesthetic.",
    technologies: [
      "Next.js 15",
      "TypeScript",
      "Tailwind CSS",
...
export function ProjectsSection() {
  return (
    <section
      id="projects"
      className="py-20 bg-background matrix-bg data-stream-vertical"
    >
      <div className="container mx-auto px-6">
        ...
        >
          <h2
            className="font-chakraPetch text-4xl md:text-5xl lg:text-6xl font-bold text-primary mb-12 glow-text glitch holographic-text"
            data-text="&gt; DIGITAL ARCHIVES_"
          >
            &gt; DIGITAL ARCHIVES_
          </h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              ...
              >
                ...
                >
                  <div
                    className={`cyber-clip bg-surface border border-border p-6 hover:shadow-2xl hover:border-primary glow-border-hover transition-all duration-300 h-full cyber-panel mouse-glow ${
                      project.featured
                        ? "floating-glow neon-border"
                        : "dynamic-border"
                    }`}
                  >
                    ...
                    <motion.div className="absolute inset-0 bg-gradient-to-r from-primary/5 to-accent/5 rounded-none opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none" />
                  </div>
                </Link>
              </motion.div>
            ))}

    ...
    >
      <div className="container mx-auto px-6 text-center">
        ...
        >
          ...
          >
            <span style={{ color: "#6b7cff" }} aria-hidden="true">
              [
            </span>
          ...
          >
            Specialized in creating modern, responsive interfaces using
            technologies such as React, Next.js, TypeScript, and Tailwind CSS.
            Also experienced in e-commerce solutions, social media management,
          ...
          >
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-secondary transform translate-x-full group-hover:translate-x-0 transition-transform duration-300"
                aria-hidden="true"
              ></div>
            </motion.a>
            ...
            >
              ...
              <div
                className="absolute inset-0 bg-primary transform translate-x-full group-hover:translate-x-0 transition-transform duration-300"
                aria-hidden="true"
              ></div>
            </motion.a>
          </motion.div>
          ...
          >
            {[
              {
                icon: Github,
                href: "https://github.com/biakp",
                label: "GitHub profile",
              },
              {
                icon: Linkedin,
                href: "https://linkedin.com/in/biakp",
